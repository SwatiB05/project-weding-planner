...
public class GlobalExceptionHandler // extends ResponseEntityExceptionHandler
{
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		//bindingResult : i/f :represent results of binding between request data n pojo properties
		for (FieldError err : ex.getBindingResult().getFieldErrors())
			validationErrs.add(err.getDefaultMessage());//adds def err msg from binding results
	...
	// handle ANY exception--equivalent to catch -all block
